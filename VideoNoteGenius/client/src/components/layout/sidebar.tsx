...
export function Sidebar({ 
  ...
  return (
    <>
      ...
      <aside className={`fixed lg:static top-0 bottom-0 left-0 z-50 lg:z-auto w-64 border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 h-full overflow-hidden flex flex-col`}>
